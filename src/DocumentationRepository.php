...
class DocumentationRepository
{
    ...
    protected function prepareCanonical()
    {
        if ($this->documentation->sectionExists($this->defaultVersion, $this->sectionPage)) {
            $this->canonical = route('wiki.show', [
     ...
     * @return $this
     */
    public function search($version, $role)
    {
        return $this->documentation->index($version, $role);
    }
